...
public class TestKijiGatherJobBuilder extends KijiClientTest {
  ...
  public static class UnconfiguredKVGatherer extends SimpleGatherer {
    ...
    public Map<String, KeyValueStore<?, ?>> getRequiredStores() {
      return RequiredStores.just("foostore", new UnconfiguredKeyValueStore<String, Object>());
    }
  }
  ...
  public void testEmptyKeyValueStore() throws Exception {
    ...
    assertEquals(1, conf.getInt(KeyValueStore.CONF_KEY_VALUE_STORE_COUNT, 0));
    assertEquals(
        EmptyKeyValueStore.class.getName(),
        conf.get(KeyValueStore.CONF_KEY_VALUE_BASE + "0.class"));
    assertEquals("foostore", conf.get(KeyValueStore.CONF_KEY_VALUE_BASE + "0.name"));
  }
}
