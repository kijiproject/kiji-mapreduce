...
public abstract class MapReduceJobBuilder<T extends MapReduceJobBuilder<T>> {
  ...
  /** Base Hadoop configuration used to build the Map/Reduce job. */
  ...
  /**
   * Sets the base Hadoop configuration used to build the Map/Reduce job.
   *
   * @param conf Base Hadoop configuration used to build the Map/Reduce job.
   * @return this.
   */
  @SuppressWarnings("unchecked")
  ...
  /** @return the base Hadoop configuration used to build the Map/Reduce job. */
